...
if( ! function_exists( 'install_premium_woocommerce_admin_notice' ) ) {
    ...
    function install_premium_woocommerce_admin_notice() { ?>
        <div class="error">
            <p><?php _ex( 'YITH WooCommerce Multi-step Checkout is enabled but not effective. It requires WooCommerce in order to work.', 'Alert Message: WooCommerce requires', 'yith-woocommerce-multi-step-checkout' ); ?></p>
        </div>
        <?php
    }
}
...
/* === DEFINE === */
! defined( 'YITH_WCMS_VERSION' )            && define( 'YITH_WCMS_VERSION', '1.3.12' );
! defined( 'YITH_WCMS_DB_VERSION' )         && define( 'YITH_WCMS_DB_VERSION', '1.0.1' );
